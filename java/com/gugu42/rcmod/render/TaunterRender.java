...
public class TaunterRender implements IItemRenderer {

	private TessellatorModel model1;
	
	public TaunterRender() {
		model1 = new TessellatorModel("/assets/rcmod/models/Taunter.obj");
