...
public class AmmoTeslaClaw implements IItemRenderer {

	private TessellatorModel model1;
    
	public AmmoTeslaClaw() {
		model1 = new TessellatorModel("/assets/rcmod/textures/gui/ammoImage/Ammo/TeslaClawAmmo/TeslaClawAmmo.obj");
