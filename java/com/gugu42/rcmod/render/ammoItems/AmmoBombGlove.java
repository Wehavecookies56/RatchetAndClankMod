...
public class AmmoBombGlove implements IItemRenderer {

	private TessellatorModel model1;
    
	public AmmoBombGlove() {
		model1 = new TessellatorModel("/assets/rcmod/textures/gui/ammoImage/Ammo/BombGloveAmmo/BombGloveAmmo.obj");
