...
public class AmmoDevastator implements IItemRenderer {

	private TessellatorModel model1;
    
	public AmmoDevastator() {
		model1 = new TessellatorModel("/assets/rcmod/textures/gui/ammoImage/Ammo/DevastatorAmmo/DevastatorAmmo.obj");
