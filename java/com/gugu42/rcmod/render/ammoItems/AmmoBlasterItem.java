...
public class AmmoBlasterItem implements IItemRenderer {

	private TessellatorModel model1;
    
	public AmmoBlasterItem() {
		model1 = new TessellatorModel("/assets/rcmod/textures/gui/ammoImage/Ammo/BlasterAmmo/BlasterAmmo.obj");
