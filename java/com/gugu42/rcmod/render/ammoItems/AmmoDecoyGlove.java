...
public class AmmoDecoyGlove implements IItemRenderer {

	private TessellatorModel model1;
    
	public AmmoDecoyGlove() {
		model1 = new TessellatorModel("/assets/rcmod/textures/gui/ammoImage/Ammo/DecoyGloveAmmo/DecoyGloveAmmo.obj");
