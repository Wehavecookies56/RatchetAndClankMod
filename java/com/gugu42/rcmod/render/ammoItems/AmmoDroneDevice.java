...
public class AmmoDroneDevice implements IItemRenderer {

	private TessellatorModel model1;
    
	public AmmoDroneDevice() {
		model1 = new TessellatorModel("/assets/rcmod/textures/gui/ammoImage/Ammo/DroneDeviceAmmo/DroneDeviceAmmo.obj");
