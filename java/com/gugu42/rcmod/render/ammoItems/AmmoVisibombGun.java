...
public class AmmoVisibombGun implements IItemRenderer {

	private TessellatorModel model1;
    
	public AmmoVisibombGun() {
		model1 = new TessellatorModel("/assets/rcmod/textures/gui/ammoImage/Ammo/VisibombGunAmmo/VisibombGunAmmo.obj");
