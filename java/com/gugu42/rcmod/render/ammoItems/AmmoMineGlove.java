...
public class AmmoMineGlove implements IItemRenderer {

	private TessellatorModel model1;
    
	public AmmoMineGlove() {
		model1 = new TessellatorModel("/assets/rcmod/textures/gui/ammoImage/Ammo/MineGloveAmmo/MineGloveAmmo.obj");
