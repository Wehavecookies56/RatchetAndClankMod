...
public class AmmoPyrocitor implements IItemRenderer {

	private TessellatorModel model1;
    
	public AmmoPyrocitor() {
		model1 = new TessellatorModel("/assets/rcmod/textures/gui/ammoImage/Ammo/PyrocitorAmmo/PyrocitorAmmo.obj");
