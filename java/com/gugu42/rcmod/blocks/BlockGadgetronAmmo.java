...
public class BlockGadgetronAmmo extends BlockFalling{
    ...
    {
		int quantity = par1Random.nextInt(4) + 1;
        return quantity;
    }
    ...
    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
    {
		...
		case 7: return RcItems.ammopyrocitor;
		case 8: return RcItems.ammoryno;
		case 9: return RcItems.ammoteslaClaw;
		case 10: return RcItems.ammovisibombGun;
