...
public class EntityBombGloveAmmo extends Entity {
	...
	public EntityBombGloveAmmo(World world, double d, double d1, double d2) {
		this(world);
		setPosition(d, d1, d2);
		yOffset = 0.0F;
	...
	public void onUpdate() {
		...
		MovingObjectPosition movingobjectposition = this.worldObj
				.rayTraceBlocks(vec3d, vec3d1, false);
		...
		if (movingobjectposition != null && !worldObj.isRemote) {
			Block k = worldObj.getBlock(movingobjectposition.blockX,
