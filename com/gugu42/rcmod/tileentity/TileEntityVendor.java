...
public class TileEntityVendor extends TileEntity implements IInventory {
	...
	public boolean isPlayerStandingNear() {
        ...
        AxisAlignedBB axisalignedbb = AxisAlignedBB.getAABBPool().getAABB((double)this.xCoord, (double)this.yCoord, (double)this.zCoord, (double)(this.xCoord + 1), (double)(this.yCoord + 1), (double)(this.zCoord + 1)).expand(4, 4, 4);
