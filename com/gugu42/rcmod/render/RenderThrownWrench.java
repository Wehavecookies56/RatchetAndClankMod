...
public class RenderThrownWrench extends Render
{
    ...
    public RenderThrownWrench(float par1){
    	model1 = AdvancedModelLoader.loadModel("/assets/rcmod/models/Omniwrench.obj");
    	textureLocation = new ResourceLocation("rcmod:models/Omniwrench.png");
    }
    public void doRenderWrenchThrown(EntityWrenchThrown par1EntityWrenchThrown, double x, double y, double z, float par8, float par9)
    {
...
//        GL11.glRotatef(this.renderManager.playerViewX, 1.0F, 0.0F, 0.0F);
    ...
    protected ResourceLocation getWrenchThrownTextures(EntityWrenchThrown par1EntityWrenchThrown)
    {
    ...
    {
        this.doRenderWrenchThrown((EntityWrenchThrown)par1Entity, par2, par4, par6, par8, par9);
    }
}
