...
public class BlockTNTCrate extends Block
{
    ...
    {
        return par1 == 0 ? this.blockBottom : (par1 == 1 ? this.blockTop : this.blockIcon);
    }
    ...
    public void onBlockDestroyedByExplosion(World par1World, int par2, int par3, int par4, Explosion par5Explosion)
    {
        ...
        {
            EntityTNTCrate entitytntcrate = new EntityTNTCrate(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F));
            entitytntcrate.fuse = par1World.rand.nextInt(entitytntcrate.fuse / 4) + entitytntcrate.fuse / 8;
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.blockTop = par1IconRegister.registerIcon(this.getTextureName() + "top");
        this.blockBottom = par1IconRegister.registerIcon(this.getTextureName() + "top");
    }
}
