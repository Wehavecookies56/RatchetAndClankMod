...
public class ClientProxy extends CommonProxy {
	...
	public void registerRenderInformation() {
		...
		MinecraftForgeClient.registerItemRenderer(RcItems.blaster.itemID,
				new BlasterRender());
		MinecraftForgeClient.registerItemRenderer(RcItems.bombGlove.itemID,
				new BombGloveRender());
		MinecraftForgeClient.registerItemRenderer(RcItems.ryno.itemID,
				new RYNORender());
		MinecraftForgeClient.registerItemRenderer(RcItems.pyrocitor.itemID,
				new PyrocitorRender());
		MinecraftForgeClient.registerItemRenderer(RcItems.walloper.itemID,
				new WalloperRender());
		MinecraftForgeClient.registerItemRenderer(
				RcItems.omniwrench3000.itemID, new OmniWrench3000Render());
		MinecraftForgeClient.registerItemRenderer(RcItems.visibombGun.itemID,
				new VisibombRender());
		MinecraftForgeClient.registerItemRenderer(RcItems.decoyGlove.itemID,
				new DecoyGloveRender());
		MinecraftForgeClient.registerItemRenderer(RcItems.devastator.itemID,
				new DevastatorRender());
		MinecraftForgeClient.registerItemRenderer(RcItems.droneDevice.itemID,
				new DroneDeviceRender());
		MinecraftForgeClient.registerItemRenderer(RcItems.gloveOfDoom.itemID,
				new GloveOfDoomRender());
		MinecraftForgeClient.registerItemRenderer(RcItems.mineGlove.itemID,
				new MineGloveRender());
		MinecraftForgeClient.registerItemRenderer(RcItems.morphORay.itemID,
				new MorphORayRender());
		MinecraftForgeClient.registerItemRenderer(RcItems.suckCannon.itemID,
				new SuckCannonRender());
		MinecraftForgeClient.registerItemRenderer(RcItems.taunter.itemID,
				new TaunterRender());
		MinecraftForgeClient.registerItemRenderer(RcItems.teslaClaw.itemID,
				new TeslaClawRender());
