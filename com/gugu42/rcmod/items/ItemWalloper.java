	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World,
		...
		if (f == 1.0F) {
			if (!par2World.isRemote) {
				TNTCrateExplosion explo = new TNTCrateExplosion(par2World, par3EntityPlayer, par3EntityPlayer.posX, par3EntityPlayer.posY, par3EntityPlayer.posZ, 1.0f, par3EntityPlayer);
